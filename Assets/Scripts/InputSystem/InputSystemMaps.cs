// GENERATED AUTOMATICALLY FROM 'Assets/Scripts/InputSystem/InputSystemMaps.inputactions'
...
public class @InputSystemMaps : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputSystemMaps()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputSystemMaps"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputSystemMaps m_Wrapper;
        public PlayerActions(@InputSystemMaps wrapper) { m_Wrapper = wrapper; }
